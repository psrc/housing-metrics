...
setwd("J:/Projects/V2050/Housing/Monitoring/2025Update/data/metric06_opportunity_RE")

write.csv(opportunity_acs_23_new, "/r_output 2023 5YR_trial.csv", row.names=FALSE)
```
