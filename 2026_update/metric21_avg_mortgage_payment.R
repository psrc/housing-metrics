...
# assumptions
export_path <- "J:/Projects/V2050/Housing/Monitoring/2026Update/Data/metric21_avg_mortgage_payment"
...
smalltbl_latestdate <- "2026-06-30"
...
smalltbl <- subset(smalltbl, select = c(date, int_rate, zori_rent, zhvi_value, payment, reqincome))
...
addWorksheet(work_book, sheetName = "smalltbl")
writeData(work_book, sheet = "smalltbl", smalltbl)
