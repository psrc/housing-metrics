...
# New data was made available from the FFIEC in June 2026. In future years consider pulling data into R directly using JSON, API. 2024 & 2023 data was cleaned to match table formatting of 2022 - watch this in future years!
...
```{r, set location}
network_file_loc<-'J:/Projects/V2050/Housing/Monitoring/2026Update/data/metric04_loan_denials'
current_year = 2025
```
...
```{r, chart 1 - Loan Denial Rates by Race and Ethnicity}
