...
# Geographies: Region
# Data Vintage: 2026 OFM April 1 estimates
...
export_path <- "J:/Projects/V2050/Housing/Monitoring/2026Update/Data/metric01_pop_growth_hu_supply"
source_info <- c("OFM April 1 Population and Housing Estimates. Data representing 1980, 1990, 2000, 2010, 2020, 2026. Calculated by Eric Clute.")

years <- c(1980, 1990, 2000, 2010, 2020, 2026)
