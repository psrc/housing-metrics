...
# SETTINGS
###########
save_path<- "J:/Projects/V2050/Housing/Monitoring/2026Update/data/metric19_cost_burden_by_race_inc/"

# years to include
years <- c(2010, 2016, 2024)
inflation_year <- 2024
final_year_for_re_smalltbl <- 2024
years_for_inc_smalltbl <- c(2010, 2024)
    ...
    mutate(
      ...
      income_bin = factor(case_when(
        ...
        HINCP2024 >= 1
                                  ...
                                  !is.na(HINCP2024) ~ "Else / Prefer not to answer"),
