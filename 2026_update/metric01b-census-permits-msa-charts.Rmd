...
export_path <- "J:/Projects/V2050/Housing/Monitoring/2026Update/data/metric1b_permitted_units"
openxlsx::write.xlsx(yrly_and_mnthly_avgs, file = file.path(export_path, "export_metric1b_yrly_mnthly_avgs.xlsx"), rowNames = FALSE)
```
