...
df_uis_owner_wide$rr_score_2022 <- (df_uis_owner_wide$moe_2022/1.645)/df_uis_owner_wide$estimate_2022*100
df_uis_owner_wide <- df_uis_owner_wide %>%
  mutate(rr_score_2010=factor(case_when(rr_score_2010 <= 15 ~"good",
         ...
         rr_score_2022=factor(case_when(rr_score_2022 <= 15 ~"good",
                                        rr_score_2022 <= 30 ~"fair",
                                        rr_score_2022 <= 50 ~"weak",
...
df_uis_renter_wide$rr_score_2022 <- (df_uis_renter_wide$moe_2022/1.645)/df_uis_renter_wide$estimate_2022*100
