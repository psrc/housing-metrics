...
# New data was made available from the FFIEC in July 2024. In future years consider pulling data into R directly using JSON, API. 2023 data was cleaned to match table formatting of 2022 - watch this in future years!
...
network_file_loc<-'J:/Projects/V2050/Housing/Monitoring/2024Update/Data/metric04_loan_denials'
```
...
region_race_23 <- region_clean[region_clean$race_ethnicity %in% c("American Indian or Alaska Native", "Asian",
...
region_race_23$share_denials_race <- region_race_23$denied/region_race_23$received

race_23_bar <- static_bar_chart(t= region_race_23,
                                x = "share_denials_race",
                                y = "race_ethnicity",
                                fill = "race_ethnicity",
                                title = "Loan Denial Rates by Race and Ethnicity (2023)",
...
```{r, chart 2 - Time Series Loan Denial Rates by Race and Ethnicity (2018-2023)}
...
denial_race_static_line <- static_line_chart(t= region_timeseries,
                                            ...
                                            lwidth = 1,
                                            color = "psrc_light",
                                            title = "Loan Denial Rates by Race and Ethnicity (2018-2023)",
...
```{r, chart 3 - Loan Denial Rates by Income and Race/Ethnicity (2023)}

region_23_income_race <- region_clean[region_clean$race_ethnicity %in% c("White", "Asian","Black or African American", "Hispanic or Latino"), ] %>%
...
region_23_income_race$share_denials_race <- region_23_income_race$denied/region_23_income_race$received
region_23_income_race$region <- "Region"

race_income_23_column <- static_column_chart(t= region_23_income_race,
                                             x = "median_income",
                                             y = "share_denials_race",
                                             fill = "race_ethnicity",
                                             title = "Loan Denial Rates by Income Bracket and Race/Ethnicity (2023)",
                                             subtitle = "Federal Financial Institutions Examination Council (FFIEC), HMDA Database",
                                             color = "psrc_light")

race_income_23_column
