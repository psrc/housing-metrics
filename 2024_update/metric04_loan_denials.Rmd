...
# NOTES: This analysis was completed for the February 2024 equity trend (https://www.psrc.org/media/8436). Data saved to 2023 monitoring directories since the data was collected for that project. New data may be available from the FFIEC in June. In future years consider pulling data into R directly using JSON, API
